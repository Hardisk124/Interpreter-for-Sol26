...
from int.src.interpreter.builtins.helper_methods import _require_block, _require_boolean, _sol_bool
from int.src.interpreter.runtime import SolObject, SolString
...
def _bool_as_string(receiver: SolObject, args: list[SolObject],
    ...
    from int.src.interpreter.class_registry import true
