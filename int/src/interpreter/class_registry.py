...
from int.src.interpreter.input_model import Block, ClassDef
from int.src.interpreter.runtime import (
    SolBlock,
    SolClass,
    SolFalse,
    SolInteger,
...
class ClassRegistry:
    ...
    def create_instance(self, sol_class: SolClass) -> SolObject:
        ...
        if name == "Block":
            ...
            from int.src.interpreter.input_model import Block as AstBlock  # to avoid circular imports
