...
from interpreter.builtins.helper_methods import _require_block, _sol_bool, _value_selector
from interpreter.error_codes import ErrorCode
from interpreter.exceptions import InterpreterError
from interpreter.runtime import SolObject
...
def _block_while_true(receiver: SolObject, args: list[SolObject],
    ...
    """
    from interpreter.class_registry import nil, true
